...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hbrBackground = (HBRUSH)(CreateSolidBrush(RGB(253, 215, 228)));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    for (int i = 0; i < 73; i++) {
        std::wstring value = std::to_wstring(i) + L".bmp";
        const wchar_t* str = _wcsdup(value.c_str());
        bmp[i] = LoadImage(NULL, str, IMAGE_BITMAP, 50, 50, LR_LOADFROMFILE);
    }
